            ...
            <div className='flex items-center gap-2 sm:gap-6'>
              <div className={`hidden md:block`}>
                <a
                  ...
                  className={`text-sm flex items-center gap-2 ${sticky
        ...
        >
          ...
          <div className="flex flex-col gap-12 text-foreground">
            ...
            <div className="flex flex-col gap-1">
              ...
              <a href="mailto:support@mytower.in" className="text-base font-medium hover:text-primary">
                support@mytower.in
              </a>
              <a href="tel:+919876543210" className="text-base font-medium hover:text-primary">
                +91 98765 43210
              </a>
            </div>
