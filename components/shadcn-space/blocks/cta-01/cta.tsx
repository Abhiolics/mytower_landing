            ...
            >
              <div className="flex flex-col gap-3 items-center text-center">
                <h2 className="text-3xl md:text-5xl font-medium">
                  Ready to Transform
                  Your Society Management?
                </h2>
                <p className="max-w-2xl mx-auto">
                  Join hundreds of societies already using MyTower to automate, secure and simplify their daily operations.
                </p>
              </div>
              <Button className="relative text-sm font-medium rounded-full h-12 p-1 ps-6 pe-14 group transition-all duration-500 hover:ps-14 hover:pe-6 w-fit overflow-hidden hover:bg-purple-600 cursor-pointer">
